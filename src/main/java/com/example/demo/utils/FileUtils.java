...
public class FileUtils {
    ...
    public static String downloadFiles(HttpServletRequest request, HttpServletResponse response, String fileName){
        ...
        String downLoadPath = "/home/guocheng/fileSave/";
        //设置文件路径
    ...
    public static String downLoad(HttpServletResponse response, String fileName,String lastName) throws UnsupportedEncodingException {
