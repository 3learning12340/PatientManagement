...
public interface FileMapper {
    ...
    List<FileOwn> queryFilesByAddress(String address);
    Employee queryFile(Integer id);
    int deleteFileById(Integer id);
    int deleteFileByPersonName(String personName);
    int deleteFileByPersonRemark(String remark,String personName);
